...
function Home() {
  ...
  return (
    <>
        <IntroCard 
            title="A Banana A day, Keeps Scurvy Away !"
            desc="Banana Product Just For Banana Lover, fruits lover and anyone in needs of vitamin C. Food n Beverages featuring banana flavour and fruits located in several cities in Malaysia."
            imgUrl={intro}
        />
